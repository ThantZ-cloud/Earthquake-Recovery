-- Complete fix: drop old policies, create admins table, recreate all policies
-- Run this ENTIRE script in Supabase SQL Editor

-- 1. Drop old policies that reference profiles (causing infinite recursion)
...
-- 2. Create admins table (for RLS checks)
...
-- 3. Recreate all policies using admins table (no recursion)
...
-- 4. Promote yourself (REPLACE 'your@email.com' with your email)
