...
const QUESTIONS = [
  ...
  {
    q: 'Which of these is a danger after an earthquake?',
  ...
  {
    q: "About what share of the world's earthquakes occur in the Ring of Fire?",
    options: ['About 10%', 'About 40%', 'About 90%', 'About 25%'],
    answer: 2,
    category: 'Geography',
  },
  {
...
export default function Quiz() {
  ...
  const STATIC_QUESTIONS = [
    ...
    { q: 'Which of these is a danger after an earthquake?', options: ['Aftershocks', 'Heavy rain', 'Cold weather', 'Strong winds'], answer: 0, category: 'Safety' },
    ...
    { q: 'What does P-waves stand for?', options: ['Primary waves', 'Power waves', 'Pressure waves', 'Passive waves'], answer: 0, category: 'Science' },
    ...
    { q: "About what share of the world's earthquakes occur in the Ring of Fire?", options: ['About 10%', 'About 40%', 'About 90%', 'About 25%'], answer: 2, category: 'Geography' },
